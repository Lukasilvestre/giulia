...
export const cretaceousContent: IntervalScientificContent = {
  ...
  tagline: "Continentes em transformação e ecossistemas em rápida diversificação.",
  ...
  fauna: [
    ...
    },
    {
      ...
      tags: ["Cretáceo Superior", "Predador"],
    },
    {
      name: "Ceratopsianos",
      subtitle: "Ceratopsia",
      description:
        "Dinossauros ceratopsianos diversificaram-se durante o Cretáceo. Triceratops é um conhecido representante do final do período.",
      tags: ["Herbívoro", "Terrestre"],
    },
    {
      name: "Mossassauros",
    ...
    },
    {
      ...
      tags: ["Vertebrados", "Diversificação"],
    },
  ],
  ...
  flora: [
    {
      ...
      tags: ["Grande transformação evolutiva"],
    },
    {
      name: "Coníferas",
      description:
  ...
  references: [
    {
      ...
      role: "Cronologia e limites estratigráficos",
    },
    {
      id: "ics-cretaceous",
      institution: "Subcommission on Cretaceous Stratigraphy",
      title: "Cretaceous Stratigraphic Scale",
      role: "Subdivisões e limites do Cretáceo",
    },
    {
      id: "nhm-cretaceous",
      institution: "Natural History Museum, London",
      title: "The Cretaceous Period",
      role: "Paleogeografia, clima, fauna e flora",
    },
    {
      id: "smithsonian-extinction",
      institution: "Smithsonian National Museum of Natural History",
      title: "Extinction Over Time",
      role: "Extinção do final do Cretáceo",
    },
    {
      id: "pbdb",
      institution: "Paleobiology Database",
      title: "Fossil occurrence database",
      role: "Ocorrências fósseis e distribuição paleobiológica",
    },
  ],
};
